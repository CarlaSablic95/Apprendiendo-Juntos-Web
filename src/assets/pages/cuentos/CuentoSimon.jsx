                ...
                <div className="mt-5 pt-5">
                        <div className="text-center mb-5">
                            ...
                            <div className="container text-center text-md-start">
                                ...
                                <p style={{ fontSize:"1.1rem" }}>Inspirado por las palabras de sus padres, Simon tomó su pincel con nueva determinación. Pintó como nunca antes, con cada trazo lleno de la alegría y la esperanza que sentía en su corazón.</p>
                                <p style={{ fontSize:"1.1rem" }}>El día de la competencia llegó, y los pintores presentaron sus obras. Había paisajes realistas, retratos detallados y escenas que parecían cobrar vida. Cuando llegó el turno de Simon, todos se quedaron en silencio. Su pintura era diferente: un paisaje sencillo pero lleno de vida, con colores que bailaban en el lienzo y transmitían una felicidad pura.</p>
                                <p style={{ fontSize:"1.1rem" }}>Los jueces quedaron impresionados. “Esta obra nos recuerda la belleza de ver el mundo a través de los ojos de un niño,” dijeron. Y así, contra todo pronóstico, Simon ganó el premio mayor.</p>
